...
class user_profile_ops:
	...
	SELL_DATA AS (SELECT user_id,security_code,trxn_type,sum(security_count) as S_security_count 
        ...
        for security in user_trxns:
            ...
            trxn_date=datetime.datetime.now()#(datetime.datetime.today() - datetime.timedelta(days=1)) 
    ...
    def user_profile_refresh(self, user):
        self.user=user
        con = psycopg2.connect("dbname='PortFolio_Tracking' user='portfolio_tracking' host='127.0.0.1' port='5432' password='portfolio_tracking'")
        cur = con.cursor()
