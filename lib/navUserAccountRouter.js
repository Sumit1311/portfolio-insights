...
module.exports = class navUserAccountRouter extends navBaseRouter {
    ...
    setup(){
        ...
        this.router.get("/uploaddata", function(req,res, next) {self.getUploadData(req,res,next)});
        this.router.post("/uploaddata", function(req,res, next) {self.postUploadData(req,res,next)});
    ...
    postUploadData(req, res ) {
        ...
        files.uploadfile.mv(path.join(process.cwd(),"data/temp"+noOfTempFiles+".xlsx"))
            .then(function(){
