...
function getDefaultConfig() {
    return {
        ...
        PythonExecutable : process.env.PYTHON_EXEC || "python3",
	StaleInterval : process.env.STALE_INTERVAL || "600000",
	RefresherInterval : process.env.REFRESHER_INTERVAL || "600000"
    }
}
