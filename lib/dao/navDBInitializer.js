...
navDatabaseInitializer.prototype.init = function () {
    ...
    return this.dbQuery('CREATE TABLE IF NOT EXISTS nav_user( ' +
        ...
        .then(function(){
            var q = 'CREATE TABLE IF NOT EXISTS stock_list_bse (' + ' security_code integer NOT NULL, ' + ' security_id text COLLATE pg_catalog."default" NOT NULL,' + ' security_name text COLLATE pg_catalog."default" NOT NULL,' + ' status text COLLATE pg_catalog."default" NOT NULL,' + ' security_group text COLLATE pg_catalog."default",' + ' face_value real,' + ' isin_no text COLLATE pg_catalog."default",' + ' industry text COLLATE pg_catalog."default",' + ' instrument text COLLATE pg_catalog."default" NOT NULL,' + ' CONSTRAINT stock_list_bse_pkey PRIMARY KEY ("security_code") ) WITH ( OIDS = FALSE )';
