...
navDatabaseInitializer.prototype.init = function () {
    ...
    return this.dbQuery('CREATE TABLE IF NOT EXISTS nav_user( ' +
        ...
        .then(function(){
            return this.dbQuery('CREATE TABLE IF NOT EXISTS nav_stock_list_bse( ' +
                '_id varchar(36) NOT NULL, ' +
                ...
                '    CONSTRAINT nav_stock_list_bse_pkey PRIMARY KEY ("_id")')
        })
        .then(function(){
            return this.dbQuery('CREATE TABLE IF NOT EXISTS nav_user_stock_profile_daily( ' +
                '_id varchar(36) NOT NULL, ' +
                ' user_id numeric(100,0) NOT NULL,' +
                '    stock_date bigint NOT NULL,' +
                '    security_count numeric(100,0),' +
                '    profile_value double precision,' +
                '    units double precision,' +
                '    nav double precision,' +
                '    seq_id bigint NOT NULL DEFAULT nextval(\'stocks.user_stock_profile_daily_seq_id_seq\'::regclass),' +
        ...
        .then(function(){
            return this.dbQuery('CREATE TABLE IF NOT EXISTS user_stocks_trxn( ' +
                '_id varchar(36) NOT NULL, ' +
                'user_id numeric(100,0) NOT NULL,' +
                '    security_code integer NOT NULL,' +
                ...
                '    trxn_seq_id bigint NOT NULL DEFAULT nextval(\'stocks.user_stocks_trxn_trxn_seq_id_seq\'::regclass)' +
