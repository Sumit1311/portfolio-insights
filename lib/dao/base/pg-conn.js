...
module.exports = class navDbConnectionHandler {
    constructor(persistence) {
        ...
        var databaseUrl = "pg://" + navConfigParser.instance().getConfig("DatabaseUser", "postgres") + ":" + navConfigParser.instance().getConfig("DatabasePassword","password") + "@" +navConfigParser.instance().getConfig("DatabaseHost") + ":" + navConfigParser.instance().getConfig("DatabasePort","5432") + "/" +navConfigParser.instance().getConfig("DatabaseName", "portfolio_insights");
    if (!databaseUrl) {
