...
module.exports = class navUploadExcel extends navBaseRouter {
    ...
    setup(){
        ...
        this.router.post('/delete', function(req,res, next) {self.deleteTransactionFullRefresh(req,res,next)});
        this.router.post('/add', function(req,res, next) {self.addTransaction(req,res,next)});
        this.router.post('/edit', function(req,res, next) {self.editTransactionFullRefresh(req,res,next)});
    ...
    deleteTransactionFullRefresh(req, res){
        var deferred = Q.defer();
        var respUtil = new navResponseUtil();
        deferred.promise
            .done(function(){
        ...
        return new navExcelFileHandler().deleteFromPortFolioFullRefresh(req.user._id, transactionId)
            .then(() => {
                deferred.resolve();
            })
            .catch((error) => {
    ...
    editTransactionFullRefresh(req, res){
        var deferred = Q.defer();
        var respUtil = new navResponseUtil();
        deferred.promise
            .done(function(){
        ...
        var data = req.body;
        return new navExcelFileHandler().editFromPortFolioFullRefresh(req.user._id, transactionId, data)
            .then((data) => {
                deferred.resolve(data);
            })
            .catch((error) => {
