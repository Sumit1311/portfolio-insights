...
module.exports = class navAccount {
    ...
    registerUser(userDetails) {
        return new navUserDAO().insertRegistrationData(userDetails.firstName, userDetails.lastName, userDetails.email, new navPasswordUtil().encryptPassword(userDetails.password), userDetails.verificationCode);
    }
    ...
    completeVerification(verificationCode ,additionalDetails) {
        ...
        .then(function () {
            ...
            return userDAO.updateUserDetails(user._id, additionalDetails.mobileNo, additionalDetails.address);
        })
        .then(function () {
    ...
    updateAccountDetails(userId, userDetail) {
        ...
        if(userDetail.password !== "") {
            ...
            return new navUserDAO().updateUserDetails(userId, userDetail.firstName, userDetail.lastName, p);
    }
}
